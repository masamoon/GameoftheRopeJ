...
import RMISolution.ClientSide.Coach.CoachRemoteCom;
...
public class ContestantThread extends Thread {
     ...
     * @param global
     */
    public ContestantThread(int contestantID, int teamID, BenchInterface bench, PlaygroundInterface playground, GlobalInterface global) {
