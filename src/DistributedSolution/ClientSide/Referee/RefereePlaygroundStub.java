 ...
 */
public class RefereePlaygroundStub {
    ...
    public void callTrial(){
        ...
        outMessage = new Message(Message.CTRIAL);
    ...
    public void startTrial(){
        ...
        outMessage = new Message(Message.STRIAL);
        con.writeObject(outMessage);
        inMessage = (Message) con.readObject();
        if (inMessage.getType () != Message.ACK) {
            GenericIO.writelnString ("Thread: Tipo inválido! teve: " + inMessage.getType () + " esperava " + Message.ACK);
    ...
    public void asserTrialDecision(){
        ...
        outMessage = new Message(Message.ASSTRIALDEC);
        con.writeObject(outMessage);
        inMessage = (Message) con.readObject();
        if (inMessage.getType () != Message.ACK) {
            GenericIO.writelnString ("Thread: Tipo inválido! teve: " + inMessage.getType () + " esperava " + Message.ACK);
